...
"")
        ...
        self.lbl_result.setGeometry(QRect(-30, 560, 411, 71))
        font14 = QFont()
        font14.setFamilies([u"Freehand521 BT"])
        font14.setPointSize(24)
        font14.setBold(True)
        self.lbl_result.setFont(font14)
        self.lbl_result.setLayoutDirection(Qt.RightToLeft)
